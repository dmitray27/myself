...
class MessageStore {
  ...
  Message addOutgoing(String from, String text, {DateTime? now}) {
    ...
    _pendingEcho.add(_PendingEcho(echoKeyFor(from, text), message, at));
  ...
  IngestOutcome ingest(
    ...
    _append(Message(frame.from, frame.text, isMine, timestamp: now));
